...
The GitHub repository for this thesis, including the source code for the POC, the source code for the evaluation, and the \LaTeX\; source for this document, can be found at \url{https://github.com/gijsh21/Generic-Traversal-Fusion-in-Strategic-Programming}.